...
# Obs: os valores arbitrários em ylim foram ajustes manuais para alinhar a
# visualização superior e inferior das linhas, ao fazer o plot de ambas
# poderia ter feito melhor, mas sabe como a vida é...
```
