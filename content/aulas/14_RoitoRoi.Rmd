...
Nesta aula, aplicaremos os conceitos de conectividade funcional 
...
Como as dimensões são diferentes (o atlas possui voxels isotrópicos em 1mm e o dado de fmri em 4mm). Veja que o atlas possui quatro vezes mais dados que o fmri.
Precisaremos fazer uma subamostragem da imagem grande para a menor, com razão 4 para 1 dos voxels do atlas.
...
Identificando o número de regiões:
```{r}
...
Para ver medidas de centralidade (somar todas as conexões):
```{r}
